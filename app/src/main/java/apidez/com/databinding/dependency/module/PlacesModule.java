...
public class PlacesModule {
    ...
    @Provides
    @ViewScope
    public IPlacesViewModel providePlacesViewModel(IPlacesApi placesApi, RxUtils.SchedulerHolder schedulerHolder) {
        return new PlacesViewModel(placesApi, schedulerHolder);
    }
}